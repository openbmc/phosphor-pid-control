...
TEST(ThermalControllerTest, NegHysteresis_BehavesAsExpected)
{
    ...
    // This test verifies Negative hysteresis behaves as expected.
    // If input value lower than setpoint minus negativeHysteresis, the last
    // input would be setpoint.
...
{
    // This test verifies Positive hysteresis behaves as expected.
    // If input not lower than setpoint minus negativeHysteresis, the last input
    // would be input.
