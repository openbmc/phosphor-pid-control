...
TEST(ThermalControllerTest, ZeroInputTest) {
...
TEST(ThermalControllerTest, MoreThanOneInputTest) {
...
TEST(ThermalControllerTest, InputProcBehaves) {
...
TEST(ThermalControllerTest, SetPtProcBehaves) {
    // This test just verifies input_proc behaves as expected.
...
TEST(ThermalControllerTest, OutputProcBehaves) {
    // This test just verifies input_proc behaves as expected.
