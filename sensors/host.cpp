    ...
    bool defer)
{
    ...
    // DegreesC and value of 0 are the defaults at present, therefore testing this
    // code only sees scale get updated as a property.
    ...
    // the initial values, so we should not let someone call this with defer=false.
