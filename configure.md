...
This build flag is used to check hysteresis using setpoint when calculating
PWM in PID controller. Without this enabled, will check hysteresis using
last input temperature.
