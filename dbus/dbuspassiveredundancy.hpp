...
/*
  DbusPassiveRedundancy monitors the fan redundancy interface via dbus match for
  changes. When the "Status" property changes to  Failed, all sensors in the
  interface's "Collection" property are added to the failed member. This
