...
{
    if (s == "Sensor D-Bus object missing") return DebugZoneInterface::FailureReason::MissingSensor;
    if (s == "Sensor reading bad")          return DebugZoneInterface::FailureReason::BadReading;
    if (s == "Margin hot")                  return DebugZoneInterface::FailureReason::MarginHot;
    if (s == "Sensor threshold asserted")   return DebugZoneInterface::FailureReason::ThresholdAsserted;
    if (s == "Sensor unavailable")          return DebugZoneInterface::FailureReason::Unavailable;
    if (s == "Sensor not functional")       return DebugZoneInterface::FailureReason::NotFunctional;
    if (s == "Sensor timeout")              return DebugZoneInterface::FailureReason::Timeout;
    if (s == "Unknown")                     return DebugZoneInterface::FailureReason::Unknown;
