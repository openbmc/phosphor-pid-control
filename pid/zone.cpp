...
void DbusPidZone::determineMaxSetPointRequest(void)
{
	...
	// if Max set point is larger than the lowest ceiling, reset to lowest ceiling.
    ...
    {
        std::cerr << "PID Zone " <<_zoneId << " max SetPoint " << _maximumSetPoint
                  << " requested by " << _maximumSetPointName << "\n";
