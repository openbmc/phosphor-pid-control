...
void from_json(const json& j, ControllerInfo& c)
{
    ...
    p.at("proportionalCoeff").get_to(c.pidInfo.p_c);
    p.at("integralCoeff").get_to(c.pidInfo.i_c);
    p.at("ff_off_coefficient").get_to(c.pidInfo.ff_off);
    p.at("ff_gain_coefficient").get_to(c.pidInfo.ff_gain);
    p.at("integralLimit_min").get_to(c.pidInfo.i_lim.min);
    p.at("integralLimit_max").get_to(c.pidInfo.i_lim.max);
    p.at("outLim_min").get_to(c.pidInfo.out_lim.min);
    p.at("outLim_max").get_to(c.pidInfo.out_lim.max);
